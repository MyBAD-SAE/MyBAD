    ...
    <AdminLayout>
        <div class="p-8">
            ...
            <Link
                ...
                class="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground mb-5"
            >
            ...
            <div class="mb-8">
                ...
                <div class="rounded-2xl border border-border overflow-hidden">
                    <!-- Table header -->
                    <div
                        class="flex items-center px-5 py-3 border-b border-border"
                    >
                        <span
                        ...
                        >
                        <span
                            class="w-32 text-right text-xs font-medium uppercase tracking-wider text-muted-foreground"
            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <div
                        class="flex items-center gap-4 rounded-2xl border border-border px-5 py-4"
                    >
                        <div
                    ...
                    >
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-muted-foreground">
                                ...
                                proportionnel à l'écart de rang.
                            </p>
                        </div>
                        <Switch
